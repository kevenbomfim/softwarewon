...
//importando a biblioteca rs2xml.jar
import net.proteanit.sql.DbUtils;

/**
 *
 * @author Eduarda Resende
 */
public class TelaCliente extends javax.swing.JInternalFrame {
    ...
    private void adicionar() {
        ...
        try {
            ...
            if ((txtCliNome.getText().isEmpty()) || (txtCliFone.getText().isEmpty())) {
                ...
                //atuaiza a tabela usuário com os dados do form
    ...
    //método para pesquisar clientes c/ filtro
    private void pesquisar_cliente() {
        String sql = "select * from tbclientes where nomecli like ?";
        try {
            pst = conexao.prepareStatement(sql);
            //passando o cntd da caixa para o ?
            //atenção a % - continuação da string
    ...
    private void alterar() {
        ...
        try {
            ...
            if ((txtCliNome.getText().isEmpty()) || (txtCliFone.getText().isEmpty())) {
                ...
                //atuaiza a tabela cliente com os dados do form
    ...
    //método remover - delete de cliente
    ...
    private void initComponents() {
        ...
        txtCliFone.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N

        btnAdicionar.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        btnAdicionar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/won/icones/create.png"))); // NOI18N
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/won/icones/pesquisar.png"))); // NOI18N

        txtCliEmail.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                ...
                                .addComponent(txtCliEndereco, javax.swing.GroupLayout.PREFERRED_SIZE, 650, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(txtCliNome, javax.swing.GroupLayout.PREFERRED_SIZE, 650, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(txtCliId, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(txtCliEmail, javax.swing.GroupLayout.PREFERRED_SIZE, 500, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addComponent(txtCliFone, javax.swing.GroupLayout.PREFERRED_SIZE, 325, javax.swing.GroupLayout.PREFERRED_SIZE))
